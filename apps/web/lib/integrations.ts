...
export function integrationCatalog(env: Record<string, string | undefined> = process.env): IntegrationInfo[] {
  ...
  return [
    ...
    { key: "whatsapp", name: "WhatsApp Business", category: "Canales", description: "Cloud API de Meta: webhook firmado, identificación del cliente y respuestas del agente.", state: "coming_soon" },
    { key: "email", name: "Email", category: "Canales", description: "Recepción, clasificación y borradores. Nunca envía sin configuración explícita.", state: "coming_soon" },
