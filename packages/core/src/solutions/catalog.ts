...
export const SOLUTIONS: SolutionDefinition[] = [
  ...
  },
  {
    ...
    description: "Consulta la disponibilidad real en Google Calendar, propone huecos dentro del horario laboral y reserva la cita cuando el cliente confirma. Sin calendario conectado, recoge los datos para que el equipo llame.",
